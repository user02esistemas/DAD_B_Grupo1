          ...
          return ListView(
            ...
            children: [
              ...
              for (final row in data.rows)
                _RecordCard(row: row, color: widget.color),
            ],
          );
        },
      ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          gradient: LinearGradient(colors: [
            widget.color,
            Color.lerp(widget.color, Colors.white, 0.28)!
          ])),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const Spacer(),
          const _Badge('Conectado al sistema')
        ]),
        const SizedBox(height: 18),
        Text(widget.title,
            style: Theme.of(context)
        ...
        Wrap(
            ...
            runSpacing: 8,
            children: data.stats
                .map((stat) => _Badge('${stat.value} ${stat.label}'))
                .toList()),
      ]),
    );
  }
