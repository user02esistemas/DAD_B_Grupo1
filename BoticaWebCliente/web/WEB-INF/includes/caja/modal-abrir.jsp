        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted">Cuenta el efectivo con el que inicias el turno (deja vac�o si es 0)</small>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-success btn-lg" onclick="CajaManager.confirmarAbrir()" id="btnConfirmarAbrir">
